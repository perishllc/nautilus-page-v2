...
const features = [
  ...
  },
  {
    ...
    description: "Your friend isn't familiar with crypto? No problem, load up a digital gift card with nano and we'll get them started.",
...
export function PrimaryFeatures() {
  return (
    <section
      ...
      className="bg-gray-900 py-20 sm:py-32 relative"
    >
      <Container>
